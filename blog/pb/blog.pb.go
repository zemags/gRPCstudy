...
func (x *ListBlogRequest) Reset() {
	*x = ListBlogRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_blog_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListBlogRequest) Descriptor() ([]byte, []int) {
	return file_api_blog_proto_rawDescGZIP(), []int{9}
}
...
func (x *ListBlogResponse) Reset() {
	*x = ListBlogResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_blog_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListBlogResponse) Descriptor() ([]byte, []int) {
	return file_api_blog_proto_rawDescGZIP(), []int{10}
}
...
var file_api_blog_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_api_blog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_blog_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_blog_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
