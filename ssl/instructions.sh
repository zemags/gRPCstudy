...
SERVER_CN=localhost # or SERVER_CN=myapi.example.com
...
openssl req -passin pass:1111 -new -key server.key -out server.csr -subj "/CN=${SERVER_CN}" -config /usr/lib/ssl/openssl.cnf
